...
public class MyAdapter_users extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView txtView = (TextView) ((LinearLayout) convertView).getChildAt(0);
        txtView.setText(user.getName());
        TextView txtView2 = (TextView) ((LinearLayout) convertView).getChildAt(1);
        txtView2.setText(user.getSurname());
        return convertView;
    }
